package com.kola.cleannotes.framework.datasource.cache
...
class NoteDaoServiceTest: BaseTest(){
    ...
    fun insertNote_CBS() = runBlocking {
        ...
        val notes = noteDaoService.searchNote()
    ...
    fun insertNoteList_CBS() = runBlocking {
        ...
        val queriedNotes = noteDaoService.searchNote()
    ...
    fun insertNote_deleteNote_confirmDeleted() = runBlocking {
        ...
        var notes = noteDaoService.searchNote()
        assert(notes.contains(newNote))

        noteDaoService.deleteNote(newNote.id)
        notes = noteDaoService.searchNote()
        assert(!notes.contains(newNote))
    }

    @Test
    fun deleteNoteList_confirmDeleted() = runBlocking {
        val noteList: ArrayList<Note> = ArrayList(noteDaoService.searchNote())
        ...
        val searchResults = noteDaoService.searchNote()
