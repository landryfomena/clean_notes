...
import com.kola.cleannotes.business.data.cache.FORCE_GENERAL_FAILURE
import com.kola.cleannotes.business.data.cache.FORCE_NEW_NOTE_EXCEPTION
...
import com.kola.cleannotes.business.interactions.notelist.RestoreDeletedNote.Companion.RESTORE_NOTE_FAILED
import com.kola.cleannotes.business.interactions.notelist.RestoreDeletedNote.Companion.RESTORE_NOTE_SUCCESS
...
class RestoreDeletedNoteTest {
    ...
    fun restoreNote_success_confirmCacheAndNetworkUpdated() =  runBlocking {
        ...
        restoreDeletedNote.retoreDeletedNote(
            note = restoredNote,
